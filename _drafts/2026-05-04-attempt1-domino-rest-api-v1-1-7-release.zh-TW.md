---
title: "Domino REST API v1.1.7 發布"
description: "HCL 於 2026 年 4 月 7 日發布了 Domino REST API v1.1.7，新增了多項功能和修正，提升了日曆和電子郵件管理的能力。"
...
HCL 於 2026 年 4 月 7 日發布了 Domino REST API v1.1.7，為開發者和管理員帶來了多項新功能和改進，特別是在日曆和電子郵件管理方面。
...
有關完整的更新內容和詳細資訊，請參閱 [Domino REST API v1.1.7 發布說明](https://opensource.hcltechsw.com/Domino-rest-api/whatsnew/v1.1.7.html)。
