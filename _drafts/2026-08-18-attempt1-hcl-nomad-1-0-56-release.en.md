---
title: "HCL Nomad 1.0.56 Release"
description: "HCL Nomad 1.0.56 is now available, introducing scheduled replication and multiple bug fixes to enhance user experience."
...
HCL Nomad version 1.0.56 has been released, bringing new features and improvements to users. Key updates in this version include:

- **Scheduled Replication**: Users can now set replication intervals directly from the updated replication page, facilitating regular data synchronization.

- **Bug Fixes**: Multiple issues have been addressed to improve the application's stability and performance.

HCL Nomad enables users to access HCL Domino applications on mobile devices and web browsers without modifying existing applications, supporting both online and offline use. For more information, refer to the [HCL Nomad App - App Store](https://apps.apple.com/us/app/hcl-nomad/id751904885) and [HCL Nomad for web browsers User Documentation](https://help.hcl-software.com/nomad/1.0_web/index.html?scLang=en).

Additionally, HCL Nomad offers multilingual support, including Traditional Chinese, ensuring a seamless experience for users worldwide. For more details on HCL Nomad implementation services, see [HCL Nomad Implementation Services | Domino People](https://dominopeople.ie/hcl-nomad-implementation/).
