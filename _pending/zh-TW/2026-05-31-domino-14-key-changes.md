...
- **14.5.1 新增**：[NotesJSONArray / NotesJSONObject / NotesJSONElement 的 Copy 方法](https://help.hcl-software.com/dom_designer/14.5.1/basic/whats_new_14.5.1.html)、跟取 OIDC token 的新 NotesSession 方法（LotusScript + Java 雙語）
