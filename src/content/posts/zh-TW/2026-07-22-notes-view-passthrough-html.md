...
![三步驟示意：Domino view 裡未閉合的 value 引號讓瀏覽器 tokenizer 進入雙引號屬性值狀態，一路吞掉 `</td><td>` 欄界線直到下一個引號，把兩欄合併成一格](/domino-news/post-images/notes-view-passthrough-unclosed-quote.png)
