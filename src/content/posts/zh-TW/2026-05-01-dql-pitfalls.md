...
HCL 官方 [DQL syntax](https://help.hcl-software.com/dom_designer/14.5.1/basic/dql_syntax.html) 文件明寫：
...
### 限制（HCL 官方 [Formula Language in DQL](https://help.hcl-software.com/dom_designer/14.5.1/basic/dql_formulalanguage.html)）
