# Domino News — Project Conventions for Codex
...
**`domino-news-tech-article`** skill (under `.Codex/skills/`) — it
...
Codex MUST end with the trailer:**
...
The trailer is symbolic — it won't show Codex in the GitHub
Insights → Contributors graph (Codex has no GitHub user account),
...
- **No "AI-generated" framing.** About / welcome / site description
  ...
  Codex / consultant / two-model-pipeline language.
...
- Skill location: `~/.Codex/skills/notebooklm/`.
...
- **Repair** (manual, via Codex-in-Chrome — needs the extension
